...
:::chart{type=line title="다우존스 산업평균 — 1928~1933 (폭락과 바닥)" label="02-1 다우 폭락"}
| 연도 | Dow |
|---|---|
| 1927 | 200 |
| 1928 | 300 |
...
:::chart{type=bar title="실업률 (%) — 미국 vs 독일 (1929~1933)" label="08-1 실업률 비교"}
| 연도 | 미국 | 독일 |
|---|---|---|
| 1929 | 3 | 9 |
| 1930 | 9 | 15 |
...
- 공공사업(정부 지출)으로 일자리 직접 창출 — TVA(테네시강 유역 개발), 도로·댐·공항 건설 등으로 수백만 명 고용. 돈이 없으면 정부가 직접 만들어 뿌리는 방식
...
:::chart{type=line title="미국 실업률 — 1929~1944 (전쟁이 만든 회복)" label="15-1 실업률 추이"}
| 연도 | 실업률 |
|---|---|
| 1929 | 3 |
| 1932 | 24 |
...
- 우리나라 사례 — 1997년 외환위기 때 IMF 구제금융. 당시 한국은행이 금리를 급격히 올려 외환을 방어했고 이후 외환보유액 관리와 한국은행의 독립성이 대폭 강화됨. 지금 한국이 외환위기에 상대적으로 강해진 건 그때의 교훈
- :key 2020년 코로나 때도 각국 중앙은행이 전례 없는 속도로 금리를 내리고 돈을 풀었음 — 대공황의 교훈이 그대로 적용된 사례
:::

:::bullets{label="17-3 사회보장제도"}
# 교훈 ③ 사회보장제도의 탄생
...
- 다른 점이 있긴함 — 지금은 세계 경제가 훨씬 더 얽혀 있고, 협상과 완화가 병행됨. 1930년대처럼 서로 문 닫고 끝까지 버티는 구도는 아님
- :key 그래도 관세 전쟁이 불황을 더 깊게 만들었다는 1930년대의 두려움이 느껴지긴함 (근데 지금 불황인 상황은 아니라 이건 오바일수도)

::chart{src="./assets/tariff-history-1821-2016.png" caption="관세율 추이 (1821–2016)" alt="US Average Tariff Rate 1821-2016"}
::chart{src="./assets/tariff-2025-timeline.png" caption="2025년 타임라인" alt="2025 US Tariff Timeline"}
:::
